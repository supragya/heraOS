...
pacstrap /mnt base grub os-prober intel-ucode efibootmgr dosfstools freetype2 fuse2 mtools iw wpa_supplicant dialog xorg xorg-server xorg-xinit xf86-video-intel
...
echo "After chrooting into newly installed OS, please run the post_ install.sh by executing ./post-install.sh"
